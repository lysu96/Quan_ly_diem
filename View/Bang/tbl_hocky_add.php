      ...
      <div class="container-fluid">
        ...
        <div class="container">
          <div class="card card-login mx-auto mt-5">
            <div class="card-header">Thêm Học kỳ</div>
            <div class="card-body">
              <form action="#" method="POST">
                ...
                <div class="form-group">
                  <div class="form-label-group">
                    <input type="text" name="txt_mahocky" id="inputMahocky" class="form-control" placeholder="Mã học kỳ" required="required">
                    <label for="inputMahocky">Mã học kỳ</label>
                  </div>
                </div>
                <div class="form-group">
                  <div class="form-label-group">
                    <input type="text" name="txt_tenhocky" id="inputTenhocky" class="form-control" placeholder="Tên học kỳ" required="required">
                    <label for="inputTenhocky">Tên học kỳ</label>
                  </div>
                </div>
                <input type="submit" name="themHocky" class="btn btn-primary btn-block" value="Thêm học kỳ">
              </form>
            </div>
          </div>
        </div>
