              ...
              <form action="#" method="POST">
                ...
                <div class="form-group">
                  <div class="form-label-group">
                    <input type="text" name="txt_malop" id="inputMalop" class="form-control" placeholder="Mã lớp" required="required">
                    <label for="inputMalop">Mã lớp</label>
                  </div>
                </div>
                <div class="form-group">
                  <div class="form-label-group">
                    <input type="text" name="txt_tenlop" id="inputTenlop" class="form-control" placeholder="Tên lớp" required="required">
                    <label for="inputTenlop">Tên lớp</label>
                  </div>
                </div>
                <input type="submit" name="themLop" class="btn btn-primary btn-block" value="Thêm lớp">
              </form>
            </div>
          </div>
        </div>
