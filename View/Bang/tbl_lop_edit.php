            ...
            <div class="card-body">
              <form action="#" method="POST">
                ...
                <?php 
                	// 	echo "<pre>";
              		// print_r($list_id_lop);
                	foreach ($list_id_lop as $key => $value) {
                 ?>
                <div class="form-group">
                  <div class="form-label-group">
                    <input type="text" name="txt_malop" id="inputMalop" class="form-control" value="<?php echo $value['ma_lop']; ?>" placeholder="Mã lớp" required="required">
                    <label for="inputMalop">Mã lớp</label>
                  </div>
                </div>
                <div class="form-group">
                  <div class="form-label-group">
                    <input type="text" name="txt_tenlop" id="inputTenlop" class="form-control" value="<?php echo $value['ten_lop']; ?>" placeholder="Tên lớp" required="required">
                    <label for="inputTenlop">Tên lớp</label>
                  </div>
                </div>
            	<?php } ?>
                <input type="submit" name="suaLop" class="btn btn-primary btn-block" value="Sửa lớp">
              </form>
            </div>
          </div>
        </div>
